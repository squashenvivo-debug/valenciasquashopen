...
const pageTranslations = {
    es: {
        ...
        sectionHeaders: {
            ...
            programming: { label: "PROGRAMA", title: "HORARIOS", intro: "Actos destacados y momentos clave del evento." },
    ...
    va: {
        ...
        sectionHeaders: {
            ...
            programming: { label: "PROGRAMA", title: "HORARIS", intro: "Actes destacats i moments clau de l'esdeveniment." },
    ...
    en: {
        ...
        sectionHeaders: {
            ...
            programming: { label: "PROGRAM", title: "SCHEDULE", intro: "Featured activities and key event moments." },
    ...
    fr: {
        ...
        sectionHeaders: {
            ...
            programming: { label: "PROGRAMME", title: "HORAIRES", intro: "Temps forts et moments clés de l'événement." },
